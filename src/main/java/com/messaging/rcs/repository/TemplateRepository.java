...
public interface TemplateRepository extends JpaRepository<Template, Long> {
	...
	@Transactional
	@Query(value = "select * from template where status=1 and template_user_id=:templateUserId", nativeQuery = true)
	List<Template> findListByTemplateByUserId(
			@Param("templateUserId") Long templateUserId);
	...
	@Transactional
	@Query(value = "select * from template where status=0", nativeQuery = true)
	...
	Integer updateStatusByTemplateId(@Param("operatorResponse") String operatorResponse,@Param("templateApproveResponse") String templateApproveResponse,
	...
	Integer rejectStatusByTemplateId(@Param("operatorResponse") String operatorResponse,@Param("templateApproveResponse") String templateApproveResponse,
			@Param("templateId") Long templateId);
