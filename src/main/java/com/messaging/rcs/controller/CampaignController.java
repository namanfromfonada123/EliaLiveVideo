...
public class CampaignController {
	...
	public ResponseEntity findAllCapmaingList(@RequestParam("from") String from, @RequestParam("to") String to,
			...
			@RequestParam(value = "campaignId", required = false) String campaignId) throws Exception {
		HashMap<String, Object> result = new HashMap<>();
		...
		try {
			...
			if (Objects.nonNull(templateId) && Objects.nonNull(campaignId)) {
				totalCampaign = this.campaignRepository
						.countByTemplateIdAndCampaingId(startDate, endDate, userId, campaignId, templateId).longValue();
