...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity.csrf().disable().cors().and().anonymous().and().authorizeRequests()
				...
				.antMatchers("/api/v1/rcsmessaging/demoRcs/callBackReport/findRcsCallBackMsgStatusFromDemoRcs").permitAll()
				.antMatchers("/api/v1/rcsmessaging/lead/**").permitAll()// allow CORS option // // calls
				...
				.antMatchers("/api/v1/rcsmessaging/campaign/**")
				.permitAll().antMatchers("/api/v1/rcsmessaging/template/**").permitAll()
