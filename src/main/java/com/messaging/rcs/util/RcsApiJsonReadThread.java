	...
	public void process(List<String> list) {
		...
		try {
			...
			if (leadInfoDetailEntityList.size() > 0) {
				...
				tokenPojo = new Gson().fromJson(botTokenAPIService.getTokenFromClientAPI(userEntity.getBotToken()), TokenPojo.class);
...
/*			jdbcTemplate.batchUpdate(
					...
					leadInfoDetailEntityList, 1000, (ps, argument) -> {
						...
						ps.setInt(21, argument.getSendToQueue());
					});
*/
			totaltime = System.currentTimeMillis() - starttime;
